...
public void setSalary(float salary) {
	 ...
	 * name.hashCode()); result = prime * result + Float.floatToIntBits(salary);
	 * return result; }
	 * 
	 ...
	 * (!name.equals(other.name)) return false; if (Float.floatToIntBits(salary) !=
	 * Float.floatToIntBits(other.salary)) return false; return true; }
	 */
